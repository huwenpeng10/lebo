...
public class FavoriteFragment extends BaseFragment {
    ...
    String mVideoUrl = "rtmp://cncplay.bingdou.tv/live/";
    ...
    private void initData() {
        OkHttpUtils
                ...
                .execute(new UserCallBack() {
                    ...
                    @Override
                    public void onResponse(final Liveing response, int id) {
                        Log.e("TAG","第一次加载数据");
...
//                                msg.obj=response.getResult().getList().get(position).getId();
//                                VideoActivity.handler.sendMessage(msg);
                                Intent intent = new Intent(getActivity(),VideoActivity.class);
                                intent.putExtra("url",mVideoUrl+response.getResult().getList().get(position).getId());
